...
- [Streaming AI Responses](production/streaming-ai-responses.md): How to deliver partial AI results safely and honestly. Covers typed events, partial state, cancellation, reconnection, structured output, streaming safety, and user experience.
